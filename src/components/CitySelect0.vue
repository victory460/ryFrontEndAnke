<template lang="html">
  <div id="example" style="width: 100%; height: 33px; text-align:center;">
  	<select v-model="prov" style="margin-left: 2%; width: 32%">
  		<option v-for="option in arr" :value="option.name">
  			{{ option.name }}
  		</option>
  	</select>
  	<select v-model="city" style="width: 32%;">
  		<option v-for="option in cityArr" :value="option.name">
  			{{ option.name }}
  		</option>
  	</select>
  	<select v-model="district" v-if="district" style="width: 32%; margin-right:2%;">
